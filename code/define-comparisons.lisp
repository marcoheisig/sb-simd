...
(sb-simd::define-comparison s64.2=  two-arg-s64.2=  u64.2-and +u64-true+)
...
(sb-simd::define-comparison f32.8=  two-arg-f32.8=  sb-simd-avx2:u32.8-and +u32-true+)
(sb-simd::define-comparison f32.8<  two-arg-f32.8<  sb-simd-avx2:u32.8-and +u32-true+)
(sb-simd::define-comparison f32.8<= two-arg-f32.8<= sb-simd-avx2:u32.8-and +u32-true+)
(sb-simd::define-comparison f32.8>  two-arg-f32.8>  sb-simd-avx2:u32.8-and +u32-true+)
(sb-simd::define-comparison f32.8>= two-arg-f32.8>= sb-simd-avx2:u32.8-and +u32-true+)

(sb-simd::define-comparison f64.4=  two-arg-f64.4=  sb-simd-avx2:u64.4-and +u64-true+)
(sb-simd::define-comparison f64.4<  two-arg-f64.4<  sb-simd-avx2:u64.4-and +u64-true+)
(sb-simd::define-comparison f64.4<= two-arg-f64.4<= sb-simd-avx2:u64.4-and +u64-true+)
(sb-simd::define-comparison f64.4>  two-arg-f64.4>  sb-simd-avx2:u64.4-and +u64-true+)
(sb-simd::define-comparison f64.4>= two-arg-f64.4>= sb-simd-avx2:u64.4-and +u64-true+)
...
(sb-simd::define-comparison s8.16=  two-arg-s8.16=  u8.16-and +u8-true+)
(sb-simd::define-comparison s8.16<  two-arg-s8.16<  u8.16-and +u8-true+)
(sb-simd::define-comparison s8.16<= two-arg-s8.16<= u8.16-and +u8-true+)
(sb-simd::define-comparison s8.16>  two-arg-s8.16>  u8.16-and +u8-true+)
(sb-simd::define-comparison s8.16>= two-arg-s8.16>= u8.16-and +u8-true+)

(sb-simd::define-comparison s16.8=  two-arg-s16.8=  u16.8-and +u16-true+)
(sb-simd::define-comparison s16.8<  two-arg-s16.8<  u16.8-and +u16-true+)
(sb-simd::define-comparison s16.8<= two-arg-s16.8<= u16.8-and +u16-true+)
(sb-simd::define-comparison s16.8>  two-arg-s16.8>  u16.8-and +u16-true+)
(sb-simd::define-comparison s16.8>= two-arg-s16.8>= u16.8-and +u16-true+)

(sb-simd::define-comparison s32.4=  two-arg-s32.4=  u32.4-and +u32-true+)
(sb-simd::define-comparison s32.4<  two-arg-s32.4<  u32.4-and +u32-true+)
(sb-simd::define-comparison s32.4<= two-arg-s32.4<= u32.4-and +u32-true+)
(sb-simd::define-comparison s32.4>  two-arg-s32.4>  u32.4-and +u32-true+)
(sb-simd::define-comparison s32.4>= two-arg-s32.4>= u32.4-and +u32-true+)
...
(sb-simd::define-comparison s8.32=  two-arg-s8.32=  u8.32-and +u8-true+)
(sb-simd::define-comparison s8.32<  two-arg-s8.32<  u8.32-and +u8-true+)
(sb-simd::define-comparison s8.32<= two-arg-s8.32<= u8.32-and +u8-true+)
(sb-simd::define-comparison s8.32>  two-arg-s8.32>  u8.32-and +u8-true+)
(sb-simd::define-comparison s8.32>= two-arg-s8.32>= u8.32-and +u8-true+)

(sb-simd::define-comparison s16.16=  two-arg-s16.16=  u16.16-and +u16-true+)
(sb-simd::define-comparison s16.16<  two-arg-s16.16<  u16.16-and +u16-true+)
(sb-simd::define-comparison s16.16<= two-arg-s16.16<= u16.16-and +u16-true+)
(sb-simd::define-comparison s16.16>  two-arg-s16.16>  u16.16-and +u16-true+)
(sb-simd::define-comparison s16.16>= two-arg-s16.16>= u16.16-and +u16-true+)

(sb-simd::define-comparison s32.8=  two-arg-s32.8=  u32.8-and +u32-true+)
(sb-simd::define-comparison s32.8<  two-arg-s32.8<  u32.8-and +u32-true+)
(sb-simd::define-comparison s32.8<= two-arg-s32.8<= u32.8-and +u32-true+)
(sb-simd::define-comparison s32.8>  two-arg-s32.8>  u32.8-and +u32-true+)
(sb-simd::define-comparison s32.8>= two-arg-s32.8>= u32.8-and +u32-true+)

(sb-simd::define-comparison s64.4=  two-arg-s64.4=  u64.4-and +u64-true+)
(sb-simd::define-comparison s64.4<  two-arg-s64.4<  u64.4-and +u64-true+)
(sb-simd::define-comparison s64.4<= two-arg-s64.4<= u64.4-and +u64-true+)
(sb-simd::define-comparison s64.4>  two-arg-s64.4>  u64.4-and +u64-true+)
(sb-simd::define-comparison s64.4>= two-arg-s64.4>= u64.4-and +u64-true+)
