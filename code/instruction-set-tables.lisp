...
(sb-simd::define-instruction-set #:avx
  ...
  (:stores
   ...
   (u16.8-store #:vmovdqu u64.2 u16vec u64.2-aref u64.2-row-major-aref)
   ...
   (s16.8-store #:vmovdqu s64.2 s16vec s64.2-aref s64.2-row-major-aref)
   ...
   ;(u16.8-ntstore  #:vmovdntq u16.8  u16vec u16.8-non-temporal-aref  u16.8-non-temporal-row-major-aref)
   ...
   ;(s16.8-ntstore  #:vmovdntq s16.8  s16vec s16.8-non-temporal-aref  s16.8-non-temporal-row-major-aref)
   ...
   ;(u16.16-ntstore #:vmovdntq u16.16 u16vec u16.16-non-temporal-aref u16.16-non-temporal-row-major-aref)
   ...
   ;(s16.16-ntstore #:vmovdntq s16.16 s16vec s16.16-non-temporal-aref s16.16-non-temporal-row-major-aref)
...
(sb-simd::define-instruction-set #:avx2
  ...
  (:load
   ...
   (u8.16-ntload #:vmovntdqa u8.4  u8vec  u8.16-non-temporal-aref u8.16-non-temporal-row-major-aref)
   (u16.8-ntload #:vmovntdqa u16.2 u16vec u16.8-non-temporal-aref u16.8-non-temporal-row-major-aref)
   ...
   (s8.16-ntload #:vmovntdqa s8.4  s8vec  s8.16-non-temporal-aref s8.16-non-temporal-row-major-aref)
