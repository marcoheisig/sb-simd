...
(sb-simd::define-instruction-set #:avx
  ...
  (:primitives
   ...
   (s16.16-shiftl      #:vpsllq   (s16.16) (s16.16 s16.16) :cost 1)
   (s16.16-shiftr      #:vpsrlq   (s16.16) (s16.16 s16.16) :cost 1)
   ;; s32.8
   ...
   (s32.8-shiftl      #:vpsllq    (s32.8) (s32.8 s32.8) :cost 1)
   (s32.8-shiftr      #:vpsrlq    (s32.8) (s32.8 s32.8) :cost 1)
