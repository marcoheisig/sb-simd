...
(sb-simd::define-instruction-set #:avx
  ...
  (:primitives
   ...
   (f64.2-vdot        #:vsqrtps   (f64)   (f64vec f64vec) :cost 22 :encoding :none)
   ;; f32.8
   ...
   (u32.4-mullo       #:vpmulld   (u32.4) (u32.4 u32.4) :cost 1)
   ;; u64.2
   ...
   (two-arg-u16.16-mullo #:vpmullw (u16.16) (u16.16 u16.8) :cost 2 :commutative t)
   ;; u32.8
   ...
   (s16.16-shiftl      #:vpslld   (s16.16) (s16.16 s16.16) :cost 1)
   (s16.16-shiftr      #:vpsrld   (s16.16) (s16.16 s16.16) :cost 1)
   ;; s32.8
   ...
   (s32.8-shiftl      #:vpslld    (s32.8) (s32.8 s32.8) :cost 1)
   (s32.8-shiftr      #:vpsrld    (s32.8) (s32.8 s32.8) :cost 1)
   (s32.8-mullo #:vpmulld (s32.8) (s32.8 s32.8) :cost 2 :commutative t)
   ;; s64.4
...
(sb-simd::define-instruction-set #:avx2
  ...
  (:primitives
   ...
   (two-arg-s32.8+    #:vpaddd       (s32.8) (s32.8 s32.8) :cost 2 :commutative t)
   (two-arg-s32.8-    #:vpsubd       (s32.8) (s32.8 s32.8) :cost 2)
   (u32.8-shiftl      #:vpsllvd      (s32.8) (s32.8 s32.8) :cost 1)
   (u32.8-shiftr      #:vpsrlvd      (u64.4) (s32.8 s32.8) :cost 1)
