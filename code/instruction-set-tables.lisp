...
(sb-simd::define-instruction-set #:avx
  ...
  (:primitives
   ...
   (f64.2-permute       #:vpermilpd    (f64.2) (f64.2 sb-simd::imm8) :cost 1)
   #+(or) ;; vshufXX is broken in SBCL
   ...
   (two-arg-s8.16/=     #:vpcmpeqw     (u8.16) (s8.16 s8.16) :cost 2 :commutative t :encoding :none)
   (two-arg-s8.16>      #:vpcmpgtw     (u8.16) (s8.16 s8.16) :cost 1)
   (two-arg-s8.16<      #:vpcmpgtw     (u8.16) (s8.16 s8.16) :cost 1 :encoding :none)
   (two-arg-s8.16>=     #:vpcmpgtw     (u8.16) (s8.16 s8.16) :cost 2 :encoding :none)
   (two-arg-s8.16<=     #:vpcmpgtw     (u8.16) (s8.16 s8.16) :cost 2 :encoding :none)
   ...
   (two-arg-s16.8/=     #:vpcmpeqw     (u16.8) (s16.8 s16.8) :cost 2 :commutative t :encoding :none)
   (two-arg-s16.8>      #:vpcmpgtw     (u16.8) (s16.8 s16.8) :cost 1)
   (two-arg-s16.8<      #:vpcmpgtw     (u16.8) (s16.8 s16.8) :cost 1 :encoding :none)
   (two-arg-s16.8>=     #:vpcmpgtw     (u16.8) (s16.8 s16.8) :cost 2 :encoding :none)
   (two-arg-s16.8<=     #:vpcmpgtw     (u16.8) (s16.8 s16.8) :cost 2 :encoding :none)
   ...
   (two-arg-s32.4/=     #:vpcmpeqq     (u32.4) (s32.4 s32.4) :cost 2 :commutative t :encoding :none)
   (two-arg-s32.4>      #:vpcmpgtq     (u32.4) (s32.4 s32.4) :cost 1)
   (two-arg-s32.4<      #:vpcmpgtq     (u32.4) (s32.4 s32.4) :cost 1 :encoding :none)
   (two-arg-s32.4>=     #:vpcmpgtq     (u32.4) (s32.4 s32.4) :cost 2 :encoding :none)
   (two-arg-s32.4<=     #:vpcmpgtq     (u32.4) (s32.4 s32.4) :cost 2 :encoding :none)
   ...
   (two-arg-s64.2/=     #:vpcmpeqq     (u64.2) (s64.2 s64.2) :cost 2 :commutative t :encoding :none)
   (two-arg-s64.2>      #:vpcmpgtq     (u64.2) (s64.2 s64.2) :cost 1)
   (two-arg-s64.2<      #:vpcmpgtq     (u64.2) (s64.2 s64.2) :cost 1 :encoding :none)
   (two-arg-s64.2>=     #:vpcmpgtq     (u64.2) (s64.2 s64.2) :cost 2 :encoding :none)
   (two-arg-s64.2<=     #:vpcmpgtq     (u64.2) (s64.2 s64.2) :cost 2 :encoding :none)
...
(sb-simd::define-instruction-set #:avx2
  ...
  (:primitives
   ...
   (u64.4-from-u8.16      #:vpmovsxbq    (u64.4) (u8.16)       :cost 5)
   ...
   (two-arg-s8.32/=       #:vpcmpeqb     (u8.32) (s8.32 s8.32)    :cost 2 :commutative t :encoding :none)
   (two-arg-s8.32>        #:vpcmpgtb     (u8.32) (s8.32 s8.32)    :cost 1)
   (two-arg-s8.32<        #:vpcmpgtb     (u8.32) (s8.32 s8.32)    :cost 1 :encoding :none)
   (two-arg-s8.32>=       #:vpcmpgtb     (u8.32) (s8.32 s8.32)    :cost 2 :encoding :none)
   (two-arg-s8.32<=       #:vpcmpgtb     (u8.32) (s8.32 s8.32)    :cost 2 :encoding :none)
   ...
   (two-arg-s16.16/=      #:vpcmpeqw     (u16.16) (s16.16 s16.16) :cost 2 :commutative t :encoding :none)
   (two-arg-s16.16>       #:vpcmpgtw     (u16.16) (s16.16 s16.16) :cost 1)
   (two-arg-s16.16<       #:vpcmpgtw     (u16.16) (s16.16 s16.16) :cost 1 :encoding :none)
   (two-arg-s16.16>=      #:vpcmpgtw     (u16.16) (s16.16 s16.16) :cost 2 :encoding :none)
   (two-arg-s16.16<=      #:vpcmpgtw     (u16.16) (s16.16 s16.16) :cost 2 :encoding :none)
   ...
   (two-arg-s32.8/=       #:vpcmpeqd     (u32.8) (s32.8 s32.8) :cost 2 :commutative t :encoding :none)
   (two-arg-s32.8>        #:vpcmpgtd     (u32.8) (s32.8 s32.8) :cost 1)
   (two-arg-s32.8<        #:vpcmpgtd     (u32.8) (s32.8 s32.8) :cost 1 :encoding :none)
   (two-arg-s32.8>=       #:vpcmpgtd     (u32.8) (s32.8 s32.8) :cost 2 :encoding :none)
   (two-arg-s32.8<=       #:vpcmpgtd     (u32.8) (s32.8 s32.8) :cost 2 :encoding :none)
   ...
   (two-arg-s64.4/=       #:vpcmpeqq     (u64.4) (s64.4 s64.4) :cost 2 :commutative t :encoding :none)
   (two-arg-s64.4>        #:vpcmpgtq     (u64.4) (s64.4 s64.4) :cost 1)
   (two-arg-s64.4<        #:vpcmpgtq     (u64.4) (s64.4 s64.4) :cost 1 :encoding :none)
   (two-arg-s64.4>=       #:vpcmpgtq     (u64.4) (s64.4 s64.4) :cost 2 :encoding :none)
   (two-arg-s64.4<=       #:vpcmpgtq     (u64.4) (s64.4 s64.4) :cost 2 :encoding :none)
