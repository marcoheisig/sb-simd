...
(sb-simd::define-instruction-set #:avx
  ...
  (:primitives
   ...
   (f64.2-permute     #:vpermilpd    (f64.2) (f64.2 u64.2) :cost 1) ;; incorrect result
   ...
   (f32.8-max         #:vmaxps       (f32.8) (f32.8 f32.8) :cost 1)
   (f32.8-min         #:vminps       (f32.8) (f32.8 f32.8) :cost 1)
   ...
   (f32.8-permute     #:vpermilps    (f32.8) (f32.8 f32.8) :cost 1)
   ...
   (f64.4-max         #:vmaxpd       (f64.4) (f64.4 f64.4) :cost 1)
   (f64.4-min         #:vminpd       (f64.4) (f64.4 f64.4) :cost 1)
...
(sb-simd::define-instruction-set #:avx2
  ...
  (:primitives
   ...
   (u8.32-max         #:vpmaxub      (u8.32) (u8.32 u8.32) :cost 2)
   (u8.32-min         #:vpminub      (u8.32) (u8.32 u8.32) :cost 2)
   ...
   (two-arg-u16.16<=   #:vpcmpgtw     (u16.16) (u16.16 u16.16) :cost 2 :encoding :none)
   (u16.16-max         #:vpmaxuw      (u16.16) (u16.16 u16.16) :cost 2)
   (u16.16-min         #:vpminuw      (u16.16) (u16.16 u16.16) :cost 2)
   ...
   (two-arg-s8.32<=   #:vpcmpgtb     (s8.32) (s8.32 s8.32) :cost 2 :encoding :none)
   (s8.32-max         #:vpmaxsb      (s8.32) (s8.32 s8.32) :cost 2)
   (s8.32-min         #:vpminsb      (s8.32) (s8.32 s8.32) :cost 2)
   ...
   (two-arg-s16.16<=     #:vpcmpgtw     (s16.16) (s16.16 s16.16) :cost 2 :encoding :none)
   (s16.16-max           #:vpmaxsw      (s16.16) (s16.16 s16.16) :cost 2)
   (s16.16-min           #:vpminsw      (s16.16) (s16.16 s16.16) :cost 2)
   ...
   (s32.8-max            #:vpmaxsd      (s32.8) (s32.8 s32.8) :cost 2)
   (s32.8-min            #:vpminsd      (s32.8) (s32.8 s32.8) :cost 2)
