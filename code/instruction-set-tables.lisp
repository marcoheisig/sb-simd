...
(sb-simd::define-instruction-set #:sse2
  ...
  (:primitives
   ...
   (two-arg-u64.2-andnot #:pandn  (u64.2) (u64.2 u64.2) :cost 1 :encoding :sse)
...
(sb-simd::define-instruction-set #:avx
  ...
  (:primitives
   ...
   (two-arg-f64.2-andnot #:vandnpd   (f64.2) (f64.2 f64.2) :cost 1)
   ...
   (two-arg-u64.2-andnot #:vpandn    (u64.2) (u64.2 u64.2) :cost 1)
