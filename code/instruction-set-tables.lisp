...
(sb-simd::define-instruction-set #:sse2
  ...
  (:primitives
   ...
   (u8.16-andnot      #:vpandn (u8.16) (u8.16 u8.16) :cost 1 :encoding :sse )
   ...
   (u16.8-andnot      #:vpandn (u16.8) (u16.8 u16.8) :cost 1 :encoding :sse)
   ...
   ;; u32.4
   (u32.4-from-f32.4  #:vcvtpd2dq (u32.4) (f32.4)    :cost 5 :encoding :sse)
   ...
   (u32.4-andnot      #:vpandn (u32.4) (u32.4 u32.4) :cost 1 :encoding :sse)
   ...
   (u64.2-andnot      #:vpandn (u64.2) (u64.2 u64.2) :cost 1 :encoding :sse)
   ...
   (s8.16-andnot      #:vpandn (s8.16) (s8.16 s8.16) :cost 1 :encoding :sse )
   ...
   (s16.8-andnot      #:vpandn (s16.8) (s16.8 s16.8) :cost 1 :encoding :sse)
   ...
   (s16.8-shiftl      #:pslld  (s16.8) (s16.8 s16.8) :cost 1 :encoding :sse)
   (s16.8-shiftr      #:psrld  (s16.8) (s16.8 s16.8) :cost 1 :encoding :sse)
   ...
   ;; s32.4
   (s32.4-from-f32.4  #:vcvtpd2dq (s32.4) (f32.4)    :cost 5 :encoding :sse)
   (s32.4-from-f64.2  #:cvtpd2dq (f32.4) (f64.2)     :cost 1 :encoding :sse)
   ...
   (s32.4-andnot      #:vpandn (s32.4) (s32.4 s32.4) :cost 1 :encoding :sse)
   ...
   (s64.2-andnot      #:vpandn (s64.2) (s64.2 s64.2) :cost 1 :encoding :sse)
...
(sb-simd::define-instruction-set #:sse4.1
  ...
  (:loads
   ...
   ;; s32.4
   ;(s32.4-mullo  #:pmulld     (s32.4) (s32.4 s32.4) :cost 1 :encoding :sse)
...
(sb-simd::define-instruction-set #:avx
  ...
  (:primitives
   ...
   ;; s32.4
   (s32.4-from-f32.4  #:vcvtpd2dq    (s32.4) (f32.4)       :cost 5)
...
(sb-simd::define-instruction-set #:avx2
  ...
  (:primitives
   ...
   (u8.32-andnot      #:vandnps      (u8.32) (u8.32 u8.32) :cost 1)
   (u8.32-not         #:vandnps      (u8.32) (u8.32)       :cost 1 :encoding :none)
   ...
   (u16.16-andnot      #:vandnps      (u16.16) (u16.16 u16.16) :cost 1)
   (u16.16-not         #:vandnps      (u16.16) (u16.16)        :cost 1 :encoding :none)
   ...
   (s8.32-andnot      #:vandnps      (s8.32) (s8.32 s8.32) :cost 1)
   (s8.32-not         #:vandnps      (s8.32) (s8.32)       :cost 1 :encoding :none)
   ...
   (two-arg-s16.16+      #:vpaddb       (s16.16) (s16.16 s16.16) :cost 2 :commutative t)
   (two-arg-s16.16-      #:vpsubw       (s16.16) (s16.16 s16.16) :cost 2)
   (s16.16-andnot        #:vandnps      (s16.16) (s16.16 s16.16) :cost 1)
   (s16.16-not           #:vandnps      (s16.16) (s16.16)       :cost 1 :encoding :none)
   ...
   ;; s32.8
   (two-arg-s32.8-and #:vandps       (s32.8) (s32.8 s32.8) :cost 1 :commutative t)
   (two-arg-s32.8-or  #:vorps        (s32.8) (s32.8 s32.8) :cost 1 :commutative t)
   (two-arg-s32.8-xor #:vxorps       (s32.8) (s32.8 s32.8) :cost 1 :commutative t)
   (two-arg-s32.8+    #:vpaddd       (s32.8) (s32.8 s32.8) :cost 2 :commutative t)
   (two-arg-s32.8-    #:vpsubd       (s32.8) (s32.8 s32.8) :cost 2)
   (s32.8-andnot      #:vandnps      (s32.8) (s32.8 s32.8) :cost 1)
   (s32.8-not         #:vandnps      (s32.8) (s32.8)       :cost 1 :encoding :none)
   ...
   ;; s64.4
   (two-arg-s64.4-and #:vandpd       (s64.4) (s64.4 s64.4) :cost 1 :commutative t)
   (two-arg-s64.4-or  #:vorpd        (s64.4) (s64.4 s64.4) :cost 1 :commutative t)
   (two-arg-s64.4-xor #:vxorpd       (s64.4) (s64.4 s64.4) :cost 1 :commutative t)
