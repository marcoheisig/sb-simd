...
(define-instruction-set :avx2
  ...
  (:instructions
   ...
   (u16.16-movemask       nil            (u16)    (u16.16)        :cost 1 :encoding :none)
   ...
   (s16.16-movemask       nil            (u16)    (s16.16)        :cost 1 :encoding :none)
  ...
  (:commutatives
   ...
   (u8.32-max two-arg-u8.32-max)
   (u8.32-min two-arg-u8.32-min)
   ...
   (u16.16-max two-arg-u16.16-max)
   (u16.16-min two-arg-u16.16-min)
   ...
   (u32.8-max two-arg-u32.8-max)
   (u32.8-min two-arg-u32.8-min)
   ...
   (s8.32-max two-arg-s8.32-max)
   (s8.32-min two-arg-s8.32-min)
   ...
   (s16.16-max two-arg-s16.16-max)
   (s16.16-min two-arg-s16.16-min)
   ...
   (s32.8-max two-arg-s32.8-max)
   (s32.8-min two-arg-s32.8-min)
