...
(define-instruction-set :avx2
  ...
  (:instructions
   ...
   (two-arg-u8.32/=       nil             (u8.32) (u8.32 u8.32)   :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-u16.16/=      nil            (u16.16) (u16.16 u16.16) :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-u32.8/=       nil            (u32.8) (u32.8 u32.8) :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-u64.4/=       nil            (u64.4) (u64.4 u64.4) :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-s8.32/=       nil            (u8.32) (s8.32 s8.32)    :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-s16.16/=      nil            (u16.16) (s16.16 s16.16) :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-s32.8/=       nil            (u32.8) (s32.8 s32.8) :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-s64.4/=       nil            (u64.4) (s64.4 s64.4) :cost 2 :commutative t :encoding :fake-vop)
