...
(define-instruction-set :sb-simd
  ...
  (:instructions
   ...
   (two-arg-f32-and nil (f32) (f32 f32) :encoding :fake-vop :commutative t)
   (two-arg-f32-or  nil (f32) (f32 f32) :encoding :fake-vop :commutative t)
   (two-arg-f32-xor nil (f32) (f32 f32) :encoding :fake-vop :commutative t)
   (two-arg-f32-max nil (f32) (f32 f32) :encoding :fake-vop :commutative t)
   (two-arg-f32-min nil (f32) (f32 f32) :encoding :fake-vop :commutative t)
   (two-arg-f32+    nil (f32) (f32 f32) :encoding :fake-vop :commutative t)
   (two-arg-f32-    nil (f32) (f32 f32) :encoding :fake-vop)
   (two-arg-f32*    nil (f32) (f32 f32) :encoding :fake-vop :commutative t)
   (two-arg-f32/    nil (f32) (f32 f32) :encoding :fake-vop)
   (two-arg-f32=    nil (u32) (f32 f32) :encoding :fake-vop :commutative t)
   (two-arg-f32/=   nil (u32) (f32 f32) :encoding :fake-vop :commutative t)
   ...
   (two-arg-f64-and nil (f64) (f64 f64) :encoding :fake-vop :commutative t)
   (two-arg-f64-or  nil (f64) (f64 f64) :encoding :fake-vop :commutative t)
   (two-arg-f64-xor nil (f64) (f64 f64) :encoding :fake-vop :commutative t)
   (two-arg-f64-max nil (f64) (f64 f64) :encoding :fake-vop :commutative t)
   (two-arg-f64-min nil (f64) (f64 f64) :encoding :fake-vop :commutative t)
   (two-arg-f64+    nil (f64) (f64 f64) :encoding :fake-vop :commutative t)
   (two-arg-f64-    nil (f64) (f64 f64) :encoding :fake-vop)
   (two-arg-f64*    nil (f64) (f64 f64) :encoding :fake-vop :commutative t)
   (two-arg-f64/    nil (f64) (f64 f64) :encoding :fake-vop)
   (two-arg-f64=    nil (u64) (f64 f64) :encoding :fake-vop :commutative t)
   (two-arg-f64/=   nil (u64) (f64 f64) :encoding :fake-vop :commutative t)
   ...
   (two-arg-u8-and nil (u8) (u8 u8) :encoding :fake-vop :commutative t)
   (two-arg-u8-or  nil (u8) (u8 u8) :encoding :fake-vop :commutative t)
   (two-arg-u8-xor nil (u8) (u8 u8) :encoding :fake-vop :commutative t)
   (two-arg-u8-max nil (u8) (u8 u8) :encoding :fake-vop :commutative t)
   (two-arg-u8-min nil (u8) (u8 u8) :encoding :fake-vop :commutative t)
   (two-arg-u8+    nil (u8) (u8 u8) :encoding :fake-vop :commutative t)
   ...
   (two-arg-u16-and nil (u16) (u16 u16) :encoding :fake-vop :commutative t)
   (two-arg-u16-or  nil (u16) (u16 u16) :encoding :fake-vop :commutative t)
   (two-arg-u16-xor nil (u16) (u16 u16) :encoding :fake-vop :commutative t)
   (two-arg-u16-max nil (u16) (u16 u16) :encoding :fake-vop :commutative t)
   (two-arg-u16-min nil (u16) (u16 u16) :encoding :fake-vop :commutative t)
   (two-arg-u16+    nil (u16) (u16 u16) :encoding :fake-vop :commutative t)
   ...
   (two-arg-u32-and nil (u32) (u32 u32) :encoding :fake-vop :commutative t)
   (two-arg-u32-or  nil (u32) (u32 u32) :encoding :fake-vop :commutative t)
   (two-arg-u32-xor nil (u32) (u32 u32) :encoding :fake-vop :commutative t)
   (two-arg-u32-max nil (u32) (u32 u32) :encoding :fake-vop :commutative t)
   (two-arg-u32-min nil (u32) (u32 u32) :encoding :fake-vop :commutative t)
   (two-arg-u32+    nil (u32) (u32 u32) :encoding :fake-vop :commutative t)
   ...
   (two-arg-u64-and nil (u64) (u64 u64) :encoding :fake-vop :commutative t)
   (two-arg-u64-or  nil (u64) (u64 u64) :encoding :fake-vop :commutative t)
   (two-arg-u64-xor nil (u64) (u64 u64) :encoding :fake-vop :commutative t)
   (two-arg-u64-max nil (u64) (u64 u64) :encoding :fake-vop :commutative t)
   (two-arg-u64-min nil (u64) (u64 u64) :encoding :fake-vop :commutative t)
   (two-arg-u64+    nil (u64) (u64 u64) :encoding :fake-vop :commutative t)
   ...
   (two-arg-s8-and nil (s8) (s8 s8) :encoding :fake-vop :commutative t)
   (two-arg-s8-or  nil (s8) (s8 s8) :encoding :fake-vop :commutative t)
   (two-arg-s8-xor nil (s8) (s8 s8) :encoding :fake-vop :commutative t)
   (two-arg-s8-max nil (s8) (s8 s8) :encoding :fake-vop :commutative t)
   (two-arg-s8-min nil (s8) (s8 s8) :encoding :fake-vop :commutative t)
   (two-arg-s8+    nil (s8) (s8 s8) :encoding :fake-vop :commutative t)
   (two-arg-s8-    nil (s8) (s8 s8) :encoding :fake-vop)
   (two-arg-s8=    nil (u8) (s8 s8) :encoding :fake-vop :commutative t)
   (two-arg-s8/=   nil (u8) (s8 s8) :encoding :fake-vop :commutative t)
   ...
   (two-arg-s16-and nil (s16) (s16 s16) :encoding :fake-vop :commutative t)
   (two-arg-s16-or  nil (s16) (s16 s16) :encoding :fake-vop :commutative t)
   (two-arg-s16-xor nil (s16) (s16 s16) :encoding :fake-vop :commutative t)
   (two-arg-s16-max nil (s16) (s16 s16) :encoding :fake-vop :commutative t)
   (two-arg-s16-min nil (s16) (s16 s16) :encoding :fake-vop :commutative t)
   (two-arg-s16+    nil (s16) (s16 s16) :encoding :fake-vop :commutative t)
   (two-arg-s16-    nil (s16) (s16 s16) :encoding :fake-vop)
   (two-arg-s16=    nil (u16) (s16 s16) :encoding :fake-vop :commutative t)
   (two-arg-s16/=   nil (u16) (s16 s16) :encoding :fake-vop :commutative t)
   ...
   (two-arg-s32-and nil (s32) (s32 s32) :encoding :fake-vop :commutative t)
   (two-arg-s32-or  nil (s32) (s32 s32) :encoding :fake-vop :commutative t)
   (two-arg-s32-xor nil (s32) (s32 s32) :encoding :fake-vop :commutative t)
   (two-arg-s32-max nil (s32) (s32 s32) :encoding :fake-vop :commutative t)
   (two-arg-s32-min nil (s32) (s32 s32) :encoding :fake-vop :commutative t)
   (two-arg-s32+    nil (s32) (s32 s32) :encoding :fake-vop :commutative t)
   (two-arg-s32-    nil (s32) (s32 s32) :encoding :fake-vop)
   (two-arg-s32=    nil (u32) (s32 s32) :encoding :fake-vop :commutative t)
   (two-arg-s32/=   nil (u32) (s32 s32) :encoding :fake-vop :commutative t)
   ...
   (two-arg-s64-and nil (s64) (s64 s64) :encoding :fake-vop :commutative t)
   (two-arg-s64-or  nil (s64) (s64 s64) :encoding :fake-vop :commutative t)
   (two-arg-s64-xor nil (s64) (s64 s64) :encoding :fake-vop :commutative t)
   (two-arg-s64-max nil (s64) (s64 s64) :encoding :fake-vop :commutative t)
   (two-arg-s64-min nil (s64) (s64 s64) :encoding :fake-vop :commutative t)
   (two-arg-s64+    nil (s64) (s64 s64) :encoding :fake-vop :commutative t)
   (two-arg-s64-    nil (s64) (s64 s64) :encoding :fake-vop)
   (two-arg-s64=    nil (u64) (s64 s64) :encoding :fake-vop :commutative t)
   (two-arg-s64/=   nil (u64) (s64 s64) :encoding :fake-vop :commutative t)
