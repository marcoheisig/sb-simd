...
(define-instruction-set :sb-simd
  ...
  (:reffers
   (f32 f32-aref f32-row-major-aref)
   (f64 f64-aref f64-row-major-aref)
   ( u8  u8-aref  u8-row-major-aref)
   (u16 u16-aref u16-row-major-aref)
   (u32 u32-aref u32-row-major-aref)
   (u64 u64-aref u64-row-major-aref)
   ( s8  s8-aref  s8-row-major-aref)
   (s16 s16-aref s16-row-major-aref)
   (s32 s32-aref s32-row-major-aref)
   (s64 s64-aref s64-row-major-aref))
  (:commutatives
