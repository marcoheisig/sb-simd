...
(define-instruction-set :avx
  ...
  (:primitives
   ...
   (two-arg-f32-or      #:vorps        (f32) (f32 f32) :cost 1 :commutative t)
   (two-arg-f32-xor     #:vxorps       (f32) (f32 f32) :cost 1 :commutative t)
   (two-arg-f32-max     #:vmaxss       (f32) (f32 f32) :cost 1 :commutative t)
   (two-arg-f32-min     #:vminss       (f32) (f32 f32) :cost 1 :commutative t)
   (two-arg-f32+        #:vaddss       (f32) (f32 f32) :cost 1 :commutative t)
   (two-arg-f32-        #:vsubss       (f32) (f32 f32) :cost 2)
   (two-arg-f32*        #:vmulss       (f32) (f32 f32) :cost 2 :commutative t)
   (two-arg-f32/        #:vdivss       (f32) (f32 f32) :cost 8)
   (two-arg-f32=        #:vcmpss       (u32) (f32 f32) :cost 4 :encoding :custom :prefix :eq :commutative t)
   (two-arg-f32/=       #:vcmpss       (u32) (f32 f32) :cost 4 :encoding :custom :prefix :neq :commutative t)
   ...
   (two-arg-f64-or      #:vorpd        (f64) (f64 f64) :cost 1 :commutative t)
   (two-arg-f64-xor     #:vxorpd       (f64) (f64 f64) :cost 1 :commutative t)
   (two-arg-f64-max     #:vmaxsd       (f64) (f64 f64) :cost 1 :commutative t)
   (two-arg-f64-min     #:vminsd       (f64) (f64 f64) :cost 1 :commutative t)
   (two-arg-f64+        #:vaddsd       (f64) (f64 f64) :cost 1 :commutative t)
   (two-arg-f64-        #:vsubsd       (f64) (f64 f64) :cost 2)
   (two-arg-f64*        #:vmulsd       (f64) (f64 f64) :cost 2 :commutative t)
   (two-arg-f64/        #:vdivsd       (f64) (f64 f64) :cost 8)
   (two-arg-f64=        #:vcmpsd       (u64) (f64 f64) :cost 4 :encoding :custom :prefix :eq :commutative t)
   (two-arg-f64/=       #:vcmpsd       (u64) (f64 f64) :cost 4 :encoding :custom :prefix :neq :commutative t)
   ...
   (f32.4!-from-p128    #:vmovups      (f32.4) (p128)        :cost 1 :encoding :move)
   (f32.4!-from-p256    #:vextractf128 (f32.4) (p256)        :cost 1 :suffix 0)
   ...
   (f32.4-blend         #:vblendps     (f32.4) (f32.4 f32.4 imm4) :cost 1)
   ...
   (f64.2!-from-p128    #:vmovupd      (f64.2) (p128)        :cost 1 :encoding :move)
   (f64.2!-from-p256    #:vextractf128 (f64.2) (p256)        :cost 1 :suffix 0)
   ...
   (f64.2-blend         #:vblendpd     (f64.2) (f64.2 f64.2 imm4) :cost 1)
   ...
   (f32.8!-from-p128    #:vmovups      (f32.8) (p128)       :cost 1 :encoding :move)
   (f32.8!-from-p256    #:vmovups      (f32.8) (p256)       :cost 1 :encoding :move)
   ...
   (f32.8-blend         #:vblendps     (f32.8) (f32.8 f32.8 imm8) :cost 1)
   ...
   (f32.8-extract128    #:vextractf128 (f32.4) (f32.8 imm1) :cost 1)
   (f32.8-insert128     #:vinsertf128  (f32.8) (f32.8 f32.4 imm1) :cost 1)
   (f32.8-round         #:vroundps     (f32.8) (f32.8 imm3) :cost 2)
   ;; f64.4
   (f64.4!-from-f64     #:vmovupd      (f64.4) (f64)         :cost 1 :encoding :move)
   (f64.4!-from-p128    #:vmovupd      (f64.4) (p128)        :cost 1 :encoding :move)
   (f64.4!-from-p256    #:vmovupd      (f64.4) (p256)        :cost 1 :encoding :move)
   ...
   (f64.4-blend         #:vblendpd     (f64.4) (f64.4 f64.4 imm4) :cost 1)
   ...
   (u8.16!-from-p128    #:vmovdqu      (u8.16) (p128)        :cost 1 :encoding :move)
   (u8.16!-from-p256    #:vextractf128 (u8.16) (p256)        :cost 1 :suffix 0)
   ...
   (two-arg-u8.16=      #:vpcmpeqb     (u8.16) (u8.16 u8.16) :cost 1 :commutative t)
   ...
   (u16.8!-from-p128    #:vmovdqu      (u16.8) (p128)        :cost 1 :encoding :move)
   (u16.8!-from-p256    #:vextractf128 (u16.8) (p256)        :cost 1 :suffix 0)
   ...
   (u32.4!-from-p128    #:vmovdqu      (u32.4) (p128)        :cost 1 :encoding :move)
   (u32.4!-from-p256    #:vextractf128 (u32.4) (p256)        :cost 1 :suffix 0)
   ...
   (u32.4-blend         #:vblendps     (u32.4) (u32.4 u32.4 imm4) :cost 1)
   (u32.4-permute       #:vpermilps    (u32.4) (u32.4 imm8)  :cost 1)
   ;; u64.2
   (u64.2!-from-u64     #:movq         (u64.2) (u64)         :cost 1)
   (u64.2!-from-p128    #:vmovdqu      (u64.2) (p128)        :cost 1 :encoding :move)
   (u64.2!-from-p256    #:vextractf128 (u64.2) (p256)        :cost 1 :suffix 0)
   ...
   (u64.2-blend         #:vblendpd     (u64.2) (u64.2 u64.2 imm4) :cost 1)
   (u64.2-permute       #:vpermilpd    (u64.2) (u64.2 imm8) :cost 1)
   ;; u8.32
   (u8.32!-from-u8      #:movq         (u8.32) (u8) :cost 1)
   (u8.32!-from-p128    #:vmovdqu      (u8.32) (p128) :cost 1 :encoding :move)
   (u8.32!-from-p256    #:vmovdqu      (u8.32) (p256) :cost 1 :encoding :move)
   ...
   (u8.32-extract128    #:vextractf128 (u8.16) (u8.32 imm1) :cost 1)
   (u8.32-insert128     #:vinsertf128  (u8.32) (u8.32 u8.16 imm1) :cost 1)
   ;; u16.16
   (u16.16!-from-u16    #:movq         (u16.16) (u16) :cost 1)
   (u16.16!-from-p128   #:vmovdqu      (u16.16) (p128) :cost 1 :encoding :move)
   (u16.16!-from-p256   #:vmovdqu      (u16.16) (p256) :cost 1 :encoding :move)
   ...
   (u16.16-extract128   #:vextractf128 (u16.8)  (u16.16 imm1) :cost 1)
   (u16.16-insert128    #:vinsertf128  (u16.16) (u16.16 u16.8 imm1) :cost 1)
   ;; u32.8
   (u32.8!-from-u32     #:movq         (u32.8) (u32) :cost 1)
   (u32.8!-from-p128    #:vmovdqu      (u32.8) (p128) :cost 1 :encoding :move)
   (u32.8!-from-p256    #:vmovdqu      (u32.8) (p256) :cost 1 :encoding :move)
   ...
   (u32.8-blend         #:vblendps     (u32.8) (u32.4 u32.4 imm8) :cost 1)
   (u32.8-permute       #:vpermilps    (u32.8) (u32.4 imm8) :cost 1)
   (u32.8-extract128    #:vextractf128 (u32.4) (u32.8 imm1) :cost 1)
   (u32.8-insert128     #:vinsertf128  (u32.8) (u32.8 u32.4 imm1) :cost 1)
   ;; u64.4
   (u64.4!-from-u64     #:movq         (u64.4) (u64) :cost 1)
   (u64.4!-from-p128    #:vmovdqu      (u64.4) (p128) :cost 1 :encoding :move)
   (u64.4!-from-p256    #:vmovdqu      (u64.4) (p256) :cost 1 :encoding :move)
   ...
   (u64.4-blend         #:vblendpd     (u64.4) (u64.4 u64.4 imm4) :cost 1)
   (u64.4-permute       #:vpermilpd    (u64.4) (u64.4 imm8) :cost 1)
   (u64.4-extract128    #:vextractf128 (u64.2) (u64.4 imm1) :cost 1)
   (u64.4-insert128     #:vinsertf128  (u64.4) (u64.4 u64.2 imm1) :cost 1)
   ;; s8.16
   (s8.16!-from-s8      nil            (s8.16) (s8)          :cost 1 :encoding :none)
   (s8.16!-from-p128    #:vmovdqu      (s8.16) (p128)        :cost 1 :encoding :move)
   (s8.16!-from-p256    #:vextractf128 (s8.16) (p256)        :cost 1 :suffix 0)
   ...
   (two-arg-s8.16+      #:vpaddb       (s8.16) (s8.16 s8.16) :cost 2 :commutative t)
   (two-arg-s8.16-      #:vpsubb       (s8.16) (s8.16 s8.16) :cost 2)
   (two-arg-s8.16=      #:vpcmpeqb     (u8.16) (s8.16 s8.16) :cost 1 :commutative t)
   ...
   (s32.4!-from-p128    #:vmovdqu      (s32.4) (p128)        :cost 1 :encoding :move)
   (s32.4!-from-p256    #:vextractf128 (s32.4) (p256)        :cost 1 :suffix 0)
   ...
   (two-arg-s32.4=      #:vpcmpeqd     (u32.4) (s32.4 s32.4) :cost 1 :commutative t)
   ...
   (s32.4-blend         #:vblendps     (s32.4) (s32.4 s32.4 imm4) :cost 1)
   (s32.4-permute       #:vpermilps    (s32.4) (s32.4 imm8) :cost 1)
   ;; s64.2
   (s64.2!-from-s64     nil            (s64.2) (s64)         :cost 1 :encoding :none)
   (s64.2!-from-p128    #:vmovdqu      (s64.2) (p128)        :cost 1 :encoding :move)
   (s64.2!-from-p256    #:vextractf128 (s64.2) (p256)        :cost 1 :suffix 0)
   ...
   (s64.2-blend         #:vblendpd     (s64.2) (s64.2 s64.2 imm4) :cost 1)
   (s64.2-permute       #:vpermilpd    (s64.2) (s64.2 imm8) :cost 1)
   ;; s8.32
   (s8.32!-from-s8      nil            (s8.32) (s8) :cost 1 :encoding :none)
   (s8.32!-from-p128    #:vmovdqu      (s8.32) (p128) :cost 1 :encoding :move)
   (s8.32!-from-p256    #:vmovdqu      (s8.32) (p256) :cost 1 :encoding :move)
   ...
   (s8.32-extract128    #:vextractf128 (s8.16) (s8.32 imm1) :cost 1)
   (s8.32-insert128     #:vinsertf128  (s8.32) (s8.32 s8.16 imm1) :cost 1)
   (s8.32-permute128    #:vperm2f128   (s8.32) (s8.32 s8.32 imm8) :cost 1)
   ;; s16.16
   (s16.16!-from-s16    nil            (s16.16) (s16) :cost 1 :encoding :none)
   (s16.16!-from-p128   #:vmovdqu      (s16.16) (p128) :cost 1 :encoding :move)
   (s16.16!-from-p256   #:vmovdqu      (s16.16) (p256) :cost 1 :encoding :move)
   ...
   (s16.16-extract128   #:vextractf128 (s16.8) (s16.16 imm1) :cost 1)
   (s16.16-insert128    #:vinsertf128  (s16.16) (s16.16 s16.8 imm1) :cost 1)
   (s16.16-permute128   #:vperm2f128   (s16.16) (s16.16 s16.16 imm8) :cost 1)
   ;; s32.8
   (s32.8!-from-s32     nil            (s32.8) (s32) :cost 1 :encoding :none)
   (s32.8!-from-p128    #:vmovdqu      (s32.8) (p128) :cost 1 :encoding :move)
   (s32.8!-from-p256    #:vmovdqu      (s32.8) (p256) :cost 1 :encoding :move)
   ...
   (s32.8-blend         #:vblendps     (s32.8) (s32.4 s32.4 imm8) :cost 1)
   (s32.8-permute       #:vpermilps    (s32.8) (s32.4 imm8) :cost 1)
   (s32.8-extract128    #:vextractf128 (s32.4) (s32.8 imm1) :cost 1)
   (s32.8-insert128     #:vinsertf128  (s32.8) (s32.8 s32.4 imm1) :cost 1)
   (s32.8-permute128    #:vperm2f128   (s32.8) (s32.8 s32.8 imm8) :cost 1)
   ;; s64.4
   (s64.4!-from-s64     nil            (s64.4) (s64) :cost 1 :encoding :none)
   (s64.4!-from-p128    #:vmovdqu      (s64.4) (p128) :cost 1 :encoding :move)
   (s64.4!-from-p256    #:vmovdqu      (s64.4) (p256) :cost 1 :encoding :move)
   ...
   (s64.4-blend         #:vblendpd     (s64.4) (s64.4 s64.4 imm4) :cost 1)
   (s64.4-permute       #:vpermilpd    (s64.4) (s64.4 imm8) :cost 1)
   (s64.4-extract128    #:vextractf128 (s64.2) (s64.4 imm1) :cost 1)
  ...
  (:loads
   ...
   (u8.16-load  #:vmovdqu u8.16  u8vec  u8.16-aref u8.16-row-major-aref)
   (u16.8-load  #:vmovdqu u16.8  u16vec u16.8-aref u16.8-row-major-aref)
   ...
   (s8.16-load  #:vmovdqu s8.16  s8vec  s8.16-aref s8.16-row-major-aref)
   (s16.8-load  #:vmovdqu s16.8  s16vec s16.8-aref s16.8-row-major-aref)
   (s32.4-load  #:vmovdqu s32.4  s32vec s32.4-aref s32.4-row-major-aref)
   (s64.2-load  #:vmovdqu s64.2  s64vec s64.2-aref s64.2-row-major-aref)
