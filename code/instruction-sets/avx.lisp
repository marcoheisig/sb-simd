...
(define-instruction-set :avx
  ...
  (:loads
   (u32.4-load-from-string #:vmovdqu u32.4 charvec u32.4-string-ref u32.4-row-major-string-ref)
   (u32.8-load-from-string #:vmovdqu u32.8 charvec u32.8-string-ref u32.8-row-major-string-ref)
  ...
  (:stores
   (u32.4-store-into-string #:vmovdqu u32.4 charvec u32.4-string-ref u32.4-row-major-string-ref)
   (u32.8-store-into-string #:vmovdqu u32.8 charvec u32.8-string-ref u32.8-row-major-string-ref)
