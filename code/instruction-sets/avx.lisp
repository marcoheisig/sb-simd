...
(define-instruction-set :avx
  ...
  (:commutatives
   ...
   (f64-max two-arg-f64-max)
   (f64-min two-arg-f64-min)
   (f64+    two-arg-f64+ 0d0)
   (f64*    two-arg-f64* 1d0)
   ...
   (f64.2-max two-arg-f64.2-max)
   (f64.2-min two-arg-f64.2-min)
   ...
   (f32.8-max two-arg-f32.8-max)
   (f32.8-min two-arg-f32.8-min)
   ...
   (f64.4-max two-arg-f64.4-max)
   (f64.4-min two-arg-f64.4-min)
   ...
   ;; These are only required for implementing other reduction operations
   ;; and the like.
