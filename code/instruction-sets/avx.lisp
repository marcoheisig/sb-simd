...
(define-instruction-set :avx
  ...
  (:instructions
   ...
   (two-arg-u8.16/=     nil            (u8.16) (u8.16 u8.16) :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-u16.8/=     nil            (u16.8) (u16.8 u16.8) :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-u32.4/=     nil            (u32.4) (u32.4 u32.4) :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-u64.2/=     nil            (u64.2) (u64.2 u64.2) :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-s8.16/=     nil            (u8.16) (s8.16 s8.16) :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-s16.8/=     nil            (u16.8) (s16.8 s16.8) :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-s32.4/=     nil            (u32.4) (s32.4 s32.4) :cost 2 :commutative t :encoding :fake-vop)
   ...
   (two-arg-s64.2/=     nil            (u64.2) (s64.2 s64.2) :cost 2 :commutative t :encoding :fake-vop)
