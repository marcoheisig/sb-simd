...
(progn
  ...
  (defun %make-simd-pack-ub8 (p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13 p14
    ...
    (declare (type (unsigned-byte 8) p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12
                                     p13 p14 p15))
    (%make-simd-pack-ub16
     (logior p0  (ash p1  8)) (logior p2  (ash p3  8))
     (logior p4  (ash p5  8)) (logior p6  (ash p7  8))
     (logior p8  (ash p9  8)) (logior p10 (ash p11 8))
...
(progn
  ...
  (defun %make-simd-pack-256-ub16 (p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13
    ...
    (%make-simd-pack-256-ub32
     ...
     (logior p8  (ash p9  16)) (logior p10 (ash p11 16))
  ...
  (defun %make-simd-pack-256-ub8 (p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13
    ...
    (%make-simd-pack-256-ub16
     ...
     (logior p8  (ash p9  8)) (logior p10 (ash p11 8))
     (logior p12 (ash p13 8)) (logior p14 (ash p15 8))
     (logior p16 (ash p17 8)) (logior p18 (ash p19 8))
     (logior p20 (ash p21 8)) (logior p22 (ash p23 8))
     (logior p24 (ash p25 8)) (logior p26 (ash p27 8))
     (logior p28 (ash p29 8)) (logior p30 (ash p31 8))))
