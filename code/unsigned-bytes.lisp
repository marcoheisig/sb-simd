...
(progn
  ...
  (defun %make-simd-pack-ub16 (p0 p1 p2 p3 p4 p5 p6 p7)
    ...
    (%make-simd-pack-ub32
     (logior p0 (ash p1 16)) (logior p2 (ash p3 16))
     (logior p4 (ash p5 16)) (logior p6 (ash p7 16))))
  ...
  (defun %simd-pack-ub16s (pack)
    ...
    (multiple-value-bind (p0 p1 p2 p3)
      ...
      (values
       (ldb (byte 16 0) p0) (ash p0 -16) (ldb (byte 16 0) p1) (ash p1 -16)
       (ldb (byte 16 0) p2) (ash p2 -16) (ldb (byte 16 0) p3) (ash p3 -16))))
  (export '%simd-pack-ub16s)

  (defun %make-simd-pack-ub8 (p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13 p14
                              p15)
    ...
    (%make-simd-pack-ub16
     ...
     (logior p12 (ash p13 8)) (logior p14 (ash p15 8))))
  (export '%make-simd-pack-ub8)
   ...
   (defun %simd-pack-ub8s (pack)
    ...
    (multiple-value-bind (p0 p1 p2 p3 p4 p5 p6 p7)
      ...
      (values (ldb (byte 8 0) p0) (ash p0 -8) (ldb (byte 8 0) p1) (ash p1 -8)
              (ldb (byte 8 0) p2) (ash p2 -8) (ldb (byte 8 0) p3) (ash p3 -8)
              (ldb (byte 8 0) p4) (ash p4 -8) (ldb (byte 8 0) p5) (ash p5 -8)
              (ldb (byte 8 0) p6) (ash p6 -8) (ldb (byte 8 0) p7) (ash p7 -8))))
...
(progn
  ...
  (defun %make-simd-pack-256-ub16 (p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13
                                   p14 p15)
    (declare (type (unsigned-byte 16) p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12
                                      p13 p14 p15))
    (%make-simd-pack-256-ub32
     (logior p0  (ash p1  16)) (logior p2  (ash p3  16)) (logior p4  (ash p5  16))
     (logior p6  (ash p7  16)) (logior p8  (ash p9  16)) (logior p10 (ash p11 16))
     (logior p12 (ash p13 16)) (logior p14 (ash p15 16))))
  ...
  (defun %simd-pack-256-ub16s (pack)
    ...
    (multiple-value-bind (p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13 p14 p15)
      ...
      (values
       (ldb (byte 16 0) p0) (ash p0 -16) (ldb (byte 16 0) p1) (ash p1 -16)
       (ldb (byte 16 0) p2) (ash p2 -16) (ldb (byte 16 0) p3) (ash p3 -16)
       (ldb (byte 16 0) p4) (ash p4 -16) (ldb (byte 16 0) p5) (ash p5 -16)
       (ldb (byte 16 0) p6) (ash p6 -16) (ldb (byte 16 0) p7) (ash p7 -16))))
  ...
  (defun %simd-pack-256-ub8s (pack)
    ...
    (multiple-value-bind (p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13 p14 p15
      ...
      (values
       (ldb (byte 8 0) p0)  (ash p0  -8) (ldb (byte 8 0) p1)  (ash p1  -8)
       (ldb (byte 8 0) p2)  (ash p2  -8) (ldb (byte 8 0) p3)  (ash p3  -8)
       (ldb (byte 8 0) p4)  (ash p4  -8) (ldb (byte 8 0) p5)  (ash p5  -8)
       (ldb (byte 8 0) p6)  (ash p6  -8) (ldb (byte 8 0) p7)  (ash p7  -8)
       (ldb (byte 8 0) p8)  (ash p8  -8) (ldb (byte 8 0) p9)  (ash p9  -8)
       (ldb (byte 8 0) p10) (ash p10 -8) (ldb (byte 8 0) p11) (ash p11 -8)
       (ldb (byte 8 0) p12) (ash p12 -8) (ldb (byte 8 0) p13) (ash p13 -8)
       (ldb (byte 8 0) p14) (ash p14 -8) (ldb (byte 8 0) p15) (ash p15 -8))))
