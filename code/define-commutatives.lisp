...
(sb-simd::define-commutative u32.4-and two-arg-u32.4-and (1- (expt 2 32)))
(sb-simd::define-commutative u32.4-or  two-arg-u32.4-or  0)
(sb-simd::define-commutative u32.4-xor two-arg-u32.4-xor 0)
(sb-simd::define-commutative u32.4+    two-arg-u32.4+    0)

(sb-simd::define-commutative u64.2-and two-arg-u64.2-and (1- (expt 2 64)))
(sb-simd::define-commutative u64.2-or  two-arg-u64.2-or  0)
(sb-simd::define-commutative u64.2-xor two-arg-u64.2-xor 0)
...
(sb-simd::define-commutative u32.8-and two-arg-u32.8-and (1- (expt 2 32)))
(sb-simd::define-commutative u32.8-or  two-arg-u32.8-or  0)
(sb-simd::define-commutative u32.8-xor two-arg-u32.8-xor 0)

(sb-simd::define-commutative u64.4-and two-arg-u64.4-and (1- (expt 2 64)))
(sb-simd::define-commutative u64.4-or  two-arg-u64.4-or  0)
(sb-simd::define-commutative u64.4-xor two-arg-u64.4-xor 0)
