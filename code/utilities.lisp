...
(defconstant +f32-true+ 1);(sb-kernel:make-single-float +s32-true+)
(defconstant +f64-true+ 1);(sb-kernel:make-double-float +s32-true+ +u32-true+)

(defconstant +f32-false+ 0);(sb-kernel:make-single-float +s32-false+)
(defconstant +f64-false+ 0);(sb-kernel:make-double-float +s32-false+ +u32-false+)
