...
(define-instruction-records +sse+
  ...
  (two-arg-f32.4=        cmpps      (s32.4)  (f32.4 f32.4)  :cost 4 :encoding :sse :prefix :eq :commutative t)
  (two-arg-f32.4/=       cmpps      (s32.4)  (f32.4 f32.4)  :cost 4 :encoding :sse :prefix :neq :commutative t)
  (two-arg-f32.4<        cmpps      (s32.4)  (f32.4 f32.4)  :cost 4 :encoding :sse :prefix :lt)
  (two-arg-f32.4<=       cmpps      (s32.4)  (f32.4 f32.4)  :cost 4 :encoding :sse :prefix :le)
  (two-arg-f32.4>        cmpps      (s32.4)  (f32.4 f32.4)  :cost 4 :encoding :sse :prefix :nle)
  (two-arg-f32.4>=       cmpps      (s32.4)  (f32.4 f32.4)  :cost 4 :encoding :sse :prefix :nlt)
...
(define-instruction-records +sse2+
  ...
  (two-arg-f64.2=        cmppd      (s64.2)  (f64.2 f64.2)  :cost 4 :encoding :sse :prefix :eq :commutative t)
  (two-arg-f64.2/=       cmppd      (s64.2)  (f64.2 f64.2)  :cost 4 :encoding :sse :prefix :neq :commutative t)
  (two-arg-f64.2<        cmppd      (s64.2)  (f64.2 f64.2)  :cost 4 :encoding :sse :prefix :lt)
  (two-arg-f64.2<=       cmppd      (s64.2)  (f64.2 f64.2)  :cost 4 :encoding :sse :prefix :le)
  (two-arg-f64.2>        cmppd      (s64.2)  (f64.2 f64.2)  :cost 4 :encoding :sse :prefix :nle)
  (two-arg-f64.2>=       cmppd      (s64.2)  (f64.2 f64.2)  :cost 4 :encoding :sse :prefix :nlt)
...
(define-instruction-records +avx+
  ...
  (two-arg-f32.4=        vcmpps     (s32.4)  (f32.4 f32.4)  :cost 4 :prefix :eq :commutative t)
  (two-arg-f32.4/=       vcmpps     (s32.4)  (f32.4 f32.4)  :cost 4 :prefix :neq :commutative t)
  (two-arg-f32.4<        vcmpps     (s32.4)  (f32.4 f32.4)  :cost 4 :prefix :lt)
  (two-arg-f32.4<=       vcmpps     (s32.4)  (f32.4 f32.4)  :cost 4 :prefix :le)
  (two-arg-f32.4>        vcmpps     (s32.4)  (f32.4 f32.4)  :cost 4 :prefix :gt)
  (two-arg-f32.4>=       vcmpps     (s32.4)  (f32.4 f32.4)  :cost 4 :prefix :ge)
  ...
  (two-arg-f64.2=        vcmppd     (s64.2)  (f64.2 f64.2)  :cost 4 :prefix :eq :commutative t)
  (two-arg-f64.2/=       vcmppd     (s64.2)  (f64.2 f64.2)  :cost 4 :prefix :neq :commutative t)
  (two-arg-f64.2<        vcmppd     (s64.2)  (f64.2 f64.2)  :cost 4 :prefix :lt)
  (two-arg-f64.2<=       vcmppd     (s64.2)  (f64.2 f64.2)  :cost 4 :prefix :le)
  (two-arg-f64.2>        vcmppd     (s64.2)  (f64.2 f64.2)  :cost 4 :prefix :gt)
  (two-arg-f64.2>=       vcmppd     (s64.2)  (f64.2 f64.2)  :cost 4 :prefix :ge)
  ...
  (two-arg-f32.8=        vcmpps     (s32.8)  (f32.8 f32.8)  :cost 4 :prefix :eq :commutative t)
  (two-arg-f32.8/=       vcmpps     (s32.8)  (f32.8 f32.8)  :cost 4 :prefix :neq :commutative t)
  (two-arg-f32.8<        vcmpps     (s32.8)  (f32.8 f32.8)  :cost 4 :prefix :lt)
  (two-arg-f32.8<=       vcmpps     (s32.8)  (f32.8 f32.8)  :cost 4 :prefix :le)
  (two-arg-f32.8>        vcmpps     (s32.8)  (f32.8 f32.8)  :cost 4 :prefix :gt)
  (two-arg-f32.8>=       vcmpps     (s32.8)  (f32.8 f32.8)  :cost 4 :prefix :ge)
  ...
  (two-arg-f64.4=        vcmppd     (s64.4)  (f64.4 f64.4)  :cost 4 :prefix :eq :commutative t)
  (two-arg-f64.4/=       vcmppd     (s64.4)  (f64.4 f64.4)  :cost 4 :prefix :neq :commutative t)
  (two-arg-f64.4<        vcmppd     (s64.4)  (f64.4 f64.4)  :cost 4 :prefix :lt)
  (two-arg-f64.4<=       vcmppd     (s64.4)  (f64.4 f64.4)  :cost 4 :prefix :le)
  (two-arg-f64.4>        vcmppd     (s64.4)  (f64.4 f64.4)  :cost 4 :prefix :gt)
  (two-arg-f64.4>=       vcmppd     (s64.4)  (f64.4 f64.4)  :cost 4 :prefix :ge)
  ...
  ;; u8.16
  (two-arg-u8.32+        vpaddb     (u8.16)  (u8.16 u8.16)  :cost 2 :commutative t)
  ...
  (s16.8-load            vmovdqu    (s16.8)  (s16vec index) :cost 7 :encoding :load)
  (s16.8-store           vmovdqu    (s16.8)  (s16.8 s16vec index) :cost 7 :encoding :store)
  (s16.8-ntstore         vmovntdq   (s16.8)  (s16.8 s16vec index) :cost 5 :encoding :store)
  ;; s32.4
  ...
  (s32.4-load            vmovdqu    (s32.4)  (u32vec index) :cost 7 :encoding :load)
  (s32.4-store           vmovdqu    (s32.4)  (s32.4 s32vec index) :cost 7 :encoding :store)
  (s32.4-ntstore         vmovntdq   (s32.4)  (s32.4 s32vec index) :cost 5 :encoding :store)
  ;; s64.2
  ...
  (s64.2-load            vmovdqu    (s64.2)  (u64vec index) :cost 7 :encoding :load)
  (s64.2-store           vmovdqu    (s64.2)  (s64.2 s64vec index) :cost 7 :encoding :store)
  (s64.2-ntstore         vmovntdq   (s64.2)  (s64.2 s64vec index) :cost 5 :encoding :store)
  ...
  (s16.16-store          vmovdqu    (s16.16)  (s16.16 s16vec index) :cost 7 :encoding :store)
  (s16.16-ntstore        vmovntdq   (s16.16)  (s16.16 s16vec index) :cost 5 :encoding :store)
  ;; s32.8
  (s32.8-broadcast       vpbroadcastd (s32.8) (s32.8)       :cost 1)
  (s32.8-load            vmovdqu    (s32.8)  (u32vec index) :cost 7 :encoding :load)
  (s32.8-store           vmovdqu    (s32.8)  (s32.8 s32vec index) :cost 7 :encoding :store)
  (s32.8-ntstore         vmovntdq   (s32.8)  (s32.8 s32vec index) :cost 5 :encoding :store)
  ;; s64.4
  (s64.4-load            vmovdqu    (s64.4)  (s64vec index) :cost 7 :encoding :load)
  (s64.4-store           vmovdqu    (s64.4)  (s64.4 s64vec index) :cost 7 :encoding :store)
  (s64.4-ntstore         vmovntdq   (s64.4)  (s64.4 s64vec index) :cost 5 :encoding :store))
...
(define-instruction-records +avx2+
  ...
  ;; u32.4
  (two-arg-u32.4=        vpcmpeqd     (s32.4)  (u32.4 u32.4) :cost 1 :commutative t)
  ...
  (two-arg-u16.16-mullo  vpmullw      (u16.16) (u16.16 u16.16) :cost 2 :commutative t)
  ...
  (two-arg-u32.8-mullo   vpmulld      (u32.8)  (u32.8 u32.8) :cost 2 :commutative t)
  (two-arg-u32.8=        vpcmpeqd     (s32.8)  (u32.8 u32.8) :cost 1 :commutative t)
  ...
  (two-arg-u64.4=        vpcmpeqq     (s64.4)  (u64.4 u64.4) :cost 1 :commutative t)
  ...
  (two-arg-s8.32-mullo   vpmullb      (s8.32) (s8.32 s8.32)  :cost 2 :commutative t)
