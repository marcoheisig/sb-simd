...
(define-instruction-records +sse2+
  ...
  (f64.2-unpackhi        unpckhpd   (f64.2)  (f64.2 f64.2) :cost 4 :first-arg-stores-result t)
  (f64.2-unpacklo        unpcklpd   (f64.2)  (f64.2 f64.2) :cost 4 :first-arg-stores-result t)
  ;; u32.4
  ...
  (u32.4-unpackhi        punpckhwd  (u32.4)  (u32.4 u32.4) :cost 1 :first-arg-stores-result t)
  (u32.4-unpacklo        punpcklwd  (u32.4)  (u32.4 u32.4) :cost 1 :first-arg-stores-result t)
  ;; u64.2
  ...
  (u64.2-unpackhi        punpckhdq  (u64.2)  (u64.2 u64.2) :cost 1 :first-arg-stores-result t)
  (u64.2-unpacklo        punpckldq  (u64.2)  (u64.2 u64.2) :cost 1 :first-arg-stores-result t))
...
(define-instruction-records +sse4.1+
  ...
  (u32.4-min             pminud     (u32.4)  (u32.4 u32.4) :cost 2 :first-arg-stores-result t)
  (u32.4-max             pmaxud     (u32.4)  (u32.4 u32.4) :cost 2 :first-arg-stores-result t)
...
(define-instruction-records +avx+
  ...
  ;; f64.2
  (f64.2-broadcast       vbroadcastsd (f64.2)  (f64)         :cost 1)
  ...
  (u32.4-min             vppminud     (u32.4)  (u32.4 u32.4) :cost 2)
  (u32.4-max             vppmaxud     (u32.4)  (u32.4 u32.4) :cost 2)
  ;; u64.2
  ...
  (u64.2-unpackhi        vunpckhdq    (u64.2)  (u64.2 u64.2) :cost 1)
  (u64.2-unpacklo        vunpckldq    (u64.2)  (u64.2 u64.2) :cost 1)
  ;; u32.8
...
(define-instruction-records +avx2+
  ...
  ;; f64.2
  (f64.2-broadcast       vbroadcastsd (f64.2)  (f64.2)       :cost 1)
  ;; f32.8
  (f32.8-broadcast       vbroadcastss (f32.8)  (f32.8)       :cost 1)
  ;; f64.4
  (f64.4-broadcast       vbroadcastsd (f64.4)  (f64.4)       :cost 1)
  ;; u32.4
  ...
  (u32.8-min             vpminud      (u32.8)  (u32.8 u32.8) :cost 2)
  (u32.8-max             vpmaxud      (u32.8)  (u32.8 u32.8) :cost 2)
  (u32.8-unpackhi        vpunpckhdq   (u32.8)  (u32.8 u32.8) :cost 1)
  (u32.8-unpacklo        vpunpckldq   (u32.8)  (u32.8 u32.8) :cost 1)
...
(define-instruction-records +fma+
  )
