  ...
  (loop
    for (name mnemonic result-records argument-records . attributes)
      in '(;; Casts
           ...
           (f32.4-two-arg-- subds (f32.4) (f32.4 f32.4) :cost 2 :first-arg-stores-result t)
           (f32.4-two-arg-* mulps (f32.4) (f32.4 f32.4) :cost 2 :first-arg-stores-result t :commutative t)
           (f32.4-two-arg-/ divps (f32.4) (f32.4 f32.4) :cost 8 :first-arg-stores-result t)
           ...
           (f32.8-two-arg-- vsubps (f32.8) (f32.8 f32.8) :cost 2)
           (f32.8-two-arg-* vmulps (f32.8) (f32.8 f32.8) :cost 2 :commutative t)
           (f32.8-two-arg-/ vdivps (f32.8) (f32.8 f32.8) :cost 8))
