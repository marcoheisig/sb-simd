...
(define-instruction-records +sse+
  ...
  (two-arg-f32.4-max     maxps      (f32.4)  (f32.4 f32.4) :cost 3 :first-arg-stores-result t)
  (two-arg-f32.4-min     minps      (f32.4)  (f32.4 f32.4) :cost 3 :first-arg-stores-result t)
  ...
  (two-arg-f32.4=        cmpps      (u32.4)  (f32.4 f32.4) :cost 4 :emitter (cmp-emitter :eq) :first-arg-stores-result t :commutative t)
  (two-arg-f32.4<        cmpps      (u32.4)  (f32.4 f32.4) :cost 4 :emitter (cmp-emitter :lt) :first-arg-stores-result t)
  (two-arg-f32.4<=       cmpps      (u32.4)  (f32.4 f32.4) :cost 4 :emitter (cmp-emitter :le) :first-arg-stores-result t)
  (two-arg-f32.4/=       cmpps      (u32.4)  (f32.4 f32.4) :cost 4 :emitter (cmp-emitter :neq) :first-arg-stores-result t :commutative t)
  (two-arg-f32.4>        cmpps      (u32.4)  (f32.4 f32.4) :cost 4 :emitter (cmp-emitter :nle) :first-arg-stores-result t)
  (two-arg-f32.4>=       cmpps      (u32.4)  (f32.4 f32.4) :cost 4 :emitter (cmp-emitter :nlt) :first-arg-stores-result t)
...
(define-instruction-records +sse2+
  ...
  (two-arg-f64.2=        cmppd      (u64.2)  (f64.2 f64.2) :cost 4 :emitter (cmp-emitter :eq) :first-arg-stores-result t :commutative t)
  (two-arg-f64.2<        cmppd      (u64.2)  (f64.2 f64.2) :cost 4 :emitter (cmp-emitter :lt) :first-arg-stores-result t)
  (two-arg-f64.2<=       cmppd      (u64.2)  (f64.2 f64.2) :cost 4 :emitter (cmp-emitter :le) :first-arg-stores-result t)
  (two-arg-f64.2/=       cmppd      (u64.2)  (f64.2 f64.2) :cost 4 :emitter (cmp-emitter :neq) :first-arg-stores-result t :commutative t)
  (two-arg-f64.2>        cmppd      (u64.2)  (f64.2 f64.2) :cost 4 :emitter (cmp-emitter :nle) :first-arg-stores-result t)
  (two-arg-f64.2>=       cmppd      (u64.2)  (f64.2 f64.2) :cost 4 :emitter (cmp-emitter :nlt) :first-arg-stores-result t)
...
(define-instruction-records +sse3+
  ...
  (f64.2-ddup            movddup    (f64.2)  (f64.2)       :cost 1))
