...
(defun simd-sum1 (array &aux (n (array-total-size array)))
  ...
  (do ((index 0 (the (integer 0 #.(- array-total-size-limit 16)) (+ index 16)))
       (acc1 (f64.4 0) (f64.4+ acc1 (f64.4-row-major-aref array (+ index 0))))
       (acc2 (f64.4 0) (f64.4+ acc2 (f64.4-row-major-aref array (+ index 4))))
       (acc3 (f64.4 0) (f64.4+ acc3 (f64.4-row-major-aref array (+ index 8))))
       (acc4 (f64.4 0) (f64.4+ acc4 (f64.4-row-major-aref array (+ index 12)))))
      ((>= index (- n 16))
